...
export default {
  ...
  data() {
    return {
      ...
      // OpenVidu Object: session에서 get하기
      OV: undefined,
      session: undefined,

      // publisher StreamManager object will be our own local webcam stream
      // and subscribers StreamManager array will store the active streams of other users in the video-call. 
      publisher: undefined, // Local
      subscribers: [],      // Remotes

      // publisher 거나 subscribers 중 하나
      ...
      this.session
        ...
        .then(() => {
          ...
          if (this.isPublisher()) {
            ...
            console.log("subscriber: this.session:");
            console.log(this.session);
