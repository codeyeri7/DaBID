<template>
  <div>
    ...
    <v-textarea
      ...
      single-line
    ></v-textarea>
    <v-btn @click="createReview" x-small color="white"  
...
export default {
  ...
  //  if로 점수 추가할 때 참고하기...
    mounted() {
      if (this.clicked1 == true || this.clicked3 == true || this.clicked5 == true) {
        this.userscore += 1
      } 
      if (this.clicked2 == true || this.clicked4 == true || this.clicked6 == true) {
        this.userscore -= 5
      }
